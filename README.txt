...
1. создаем .env и настраиваем в нем подключеие к БД, а также меняем очередь на QUEUE_CONNECTION=database
...
4. Добавляем тестовых пользователей с нужными правами,
