...
import ControlCenterNavbar from "../components/includes/ControlCenterNavbar.vue";
import ControlCenterSidebar from "../components/includes/ControlCenterSidebar.vue";
...
const crumbs = computed(() => {
    let pathArray = route.path.split('/')
      pathArray.shift()
      const breadCrumbs = [{ "href": "/control-center", "disabled": false, "text": "Control center" }]
