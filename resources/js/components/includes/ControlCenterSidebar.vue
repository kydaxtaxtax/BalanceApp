    ...
    <nav class="bg-white sidebar">
        <div class="pt-3 sidebar-sticky">
            <ul id="menu" class="nav flex-column mb-2">
                <li class="nav-item">
                    <router-link to="/control-center" class="nav-link">
                        ...
                        <span class="d-none d-sm-inline ps-2">Control center</span>
                    </router-link>
                </li>
                ...
                <li v-if="can('account-index')" class="nav-item">
                    <router-link :to="{ name: 'account.index' }" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                            <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM2 13s-1 0-1-1 1-4 7-4 7 4 7 4-1 1-1 1H2z"/>
                        </svg>

                        <span class="d-none d-sm-inline ps-2">Account</span>
                    </router-link>
                </li>
                <li v-if="can('operation-index')" class="nav-item">
                    <router-link :to="{ name: 'operations.index' }" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
                        </svg>
                        <span class="d-none d-sm-inline ps-2">Operations</span>
                    </router-link>
                </li>
            </ul>
        </div>
